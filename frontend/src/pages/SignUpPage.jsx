...
const SignUpPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full bg-[#e4652553] bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl 
			overflow-hidden"
    >
      <div className="p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          <motion.button
            className="mt-5 w-full py-3 px-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white 
						font-bold rounded-lg shadow-lg hover:from-orange-600 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2
